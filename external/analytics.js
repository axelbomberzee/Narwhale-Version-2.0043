...
}
{
    ...
    (function() {
        ...
        var oc = function() {
            return (Ba || Ud() ? "https:" : "http:") + "//web.archive.org/web/20161216170252/http://www.google-analytics.com"
        }
          , Da = function(a) {
            this.name = "len";
            this.message = a + "-8192"
        ...
        ;var p = /^(GTM|OPT)-[A-Z0-9]+$/
          ...
          , t = function(a) {
            ...
            var c = "https://web.archive.org/web/20161216170252/https://www.google-analytics.com/gtm/js?id=" + K(a.id);
        ...
        var fd = function(a, b) {
            ...
            if (!c.get("dcLoaded")) {
                ...
                var d;
                b[U] && (d = Cc(b[U]));
                d = new Jd(c,"https://web.archive.org/web/20161216170252/https://stats.g.doubleclick.net/r/collect?t=dc&aip=1&_r=3&",d);
                Rd(d, c);
                c.set("dcLoaded", !0)
            }
        };
        ...
        var ad, bd = function(a, b, c) {
            if (!ad) {
                ...
                if (e = (d = (d = d && d.match(g) || e && e.match(g)) ? d[1] : Ca("GASO")[0] || "") && d.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i))
                    ...
                    a = e[1],
                    wa("https://web.archive.org/web/20161216170252/https://www.google.com/analytics/web/inpage/pub/inpage.js?" + (a ? "prefix=" + a + "&" : "") + hd(), "_gasojs");
                ad = !0
            }
        };
        ...
        var u = function(a, b, c) {
          ...
          , y = function(a, b, c, d, e) {
            if (!ea(Yd.get(b)) && !$d.get(b)) {
                ...
                c = b + ".js") : J(43);
                c && (c && 0 <= c.indexOf("/") || (c = (Ba || Ud() ? "https:" : "http:") + "//web.archive.org/web/20161216170252/http://www.google-analytics.com/plugins/ua/" + c),
                d = ae(c),
                a = d.protocol,
          ...
          , B = function(a) {
            ...
            if (D(a.url, "https://web.archive.org/web/20161216170252/https://www.google-analytics.com/gtm/js?id="))
                return !0;
                ...
                if (!Ud() && !Ba) {
                    a: {
                        for (var b = M.getElementsByTagName("script"), c = 0; c < b.length && 100 > c; c++) {
                            var d = b[c].src;
                            if (d && 0 == d.indexOf("https://web.archive.org/web/20161216170252/https://www.google-analytics.com/analytics")) {
                                J(33);
                                b = !0;
                                break a
                            }
...
/*
     FILE ARCHIVED ON 17:02:52 Dec 16, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 01:22:46 Nov 30, 2025.
...
playback timings (ms):
  ...
  esindex: 0.016
  cdx.remote: 20.877
  LoadShardBlock: 92.694 (3)
  PetaboxLoader3.datanode: 150.305 (5)
  load_resource: 256.575 (2)
  PetaboxLoader3.resolve: 169.0 (2)
*/
